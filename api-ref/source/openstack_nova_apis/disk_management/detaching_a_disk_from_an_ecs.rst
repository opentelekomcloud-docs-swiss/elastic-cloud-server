...
#. Disks which are forcibly detached online will use the disk drives and PCI addresses. Therefore, the disk drives and PCI addresses will not be assigned again.
