...
If your ECS runs slowly or is inaccessible unexpectedly, the bandwidth or vCPU usage of the ECS may be excessively high. If you have using Cloud Eye, the system automatically sends an alarm to you when the bandwidth or CPU usage reaches the threshold specified in the rule.
...
2. Troubleshooting
   ...
   -  If the processes are not malicious, optimize them or .
...
#. Check whether any applications requiring high CPU or bandwidth are running on the ECS. If so, or .
